...
int main()
{
    ...
    do {
        ...
        cout << "14. . " << endl;
        cout << "15. Determina voltaje correcto, alto o peligro." << endl;
        cout << "16. la hora en españa teniendo la hora en colombia" << endl;
        cout << "17. la hora en arabia saudita teniendo la hora en colombia" << endl;
        cout << "18. la hora en beijin teniendo la hora en colombia" << endl;
        cout << "0. SALIR" << endl;
